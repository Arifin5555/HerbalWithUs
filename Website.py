...
SampleTw = 'static/Tw.png'
SamplePanduan= 'static/Panduan.png'
SampleAbout ='static/aboutme.png'
SampleFTI= 'static/untar.png'
...
def load_model_from_file():
	...
	myModel = load_model('modelklasifikasibenar.pkl')
...
@app.route('/Panduan')
def halaman3():
	return render_template('TentangAplikasi.html',MyP=P,mySamplePanduan=SamplePanduan)

@app.route('/About')
def halaman4():
	return render_template('about.html', mySampleAbout=SampleAbout, mySampleFTI=SampleFTI)
